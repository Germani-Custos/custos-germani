...
import { calculateCascadeOptions, buildReportRows, calculateKpis } from '../core/report-engine.js';
import { createInitialState } from './ui-state.js';
import { getDomRefs } from './ui-dom.js';
import { debugLog } from '../src/config/app-config.js';
import { escapeHtml, showToast, fillSelect } from './ui-utils.js';
...
const exporter = createExportController({
  ...
  state,
  executeOperationalBoundary,
  getOperationalPriority: table.getOperationalPriority,
  buildInvestigativeSummary: table.buildInvestigativeSummary
});
